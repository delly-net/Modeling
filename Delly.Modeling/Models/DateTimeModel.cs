...
namespace Delly.Modeling.Models
{
    ...
    /// DateTime建模
    /// </summary>
    public sealed class DateTimeModel : IModel
    {
        // 固定静态共享实例
        ...
        /// <exception cref="NotSupportedException">DateTimeModel 不支持泛型建模创建</exception>
        public IModel MakeGenericModel(params IModel[] models)
        {
            throw new NotSupportedException("DateTimeModel 不支持泛型建模创建");
        }
    }
}