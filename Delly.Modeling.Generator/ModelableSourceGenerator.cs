...
public class ModelableSourceGenerator : ISourceGenerator
{
    ...
    private static string GenerateSourceCode(GeneratorExecutionContext context, string namespaceName, string className, List<IPropertySymbol> properties, List<ConstructorInfo> constructors, INamedTypeSymbol targetClass)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// 是否为泛型模型");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    public bool IsGenericModel => false;");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// 是否为开放泛型定义");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    public bool IsGenericDefinition => false;");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// 泛型定义数量");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    public int GenericDefinitionCount => 0;");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// 获取集合");
        sb.AppendLine("    /// </summary>");
        ...
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// 获取泛型模型的定义模型");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    /// <returns>自身</returns>");
        sb.AppendLine("    public IModel GetGenericModelDefinition()");
        sb.AppendLine("    {");
        sb.AppendLine("        return this;");
        sb.AppendLine("    }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// 获取所有已构造的泛型模型");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    /// <returns>空列表</returns>");
        sb.AppendLine("    public IReadOnlyList<IModel> GetGenericModels()");
        sb.AppendLine("    {");
        sb.AppendLine("        return Array.Empty<IModel>();");
        sb.AppendLine("    }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// 根据泛型参数创建已构造的泛型模型");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    /// <param name=\"models\">泛型参数对应的模型列表</param>");
        sb.AppendLine("    /// <returns>已构造的泛型模型</returns>");
        sb.AppendLine($"    /// <exception cref=\"NotSupportedException\">{className} 不支持泛型建模创建</exception>");
        sb.AppendLine("    public IModel MakeGenericModel(params IModel[] models)");
        sb.AppendLine("    {");
        sb.AppendLine($"        throw new NotSupportedException(\"{className} 不支持泛型建模创建\");");
        sb.AppendLine("    }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
