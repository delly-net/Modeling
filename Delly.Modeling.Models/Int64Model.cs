...
namespace Delly.Modeling.Models
{
    ...
    public sealed class Int64Model : IBaseModel
    {
...
#endif
        {
            ...
            if (result == null) { throw new ArgumentException($"Cannot convert {obj?.GetType().Name ?? "null"} to Int64"); }
            return result;
        }
...
#endif
        {
            ...
            if (obj is long value) { return value; }

            if (obj is string str && long.TryParse(str, out var longVal)) { return longVal; }

            if (obj is int intVal) { return (long)intVal; }
